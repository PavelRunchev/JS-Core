class Kitchen {
    ...
    makeTheOrder(meal) {
        ...
        for (let ingredient of currentMeal['products']) {
            let [ingredName, ingredQuantity] = ingredient.split(' ');
...
console.log(kitchen.loadProducts(['Flour 0.5 1.20', 'Oil 0.2 3.00', 'Yeast 0.5 1.50', 'Salt 0.1 0.20', 'Sugar 0.1 0.50', 'Tomato sauce 0.5 0.90', 'Pepperoni 1 2000', 'Cheese 1.5 3.50']));
